...
import ImagePullSecretType from './ImagePullSecretTypeConfiguration';

const ContainerConfiguration = ({ state, ableToEdit, onChange, openModal, t }) => {
...
export default withTranslation()(ContainerConfiguration);
